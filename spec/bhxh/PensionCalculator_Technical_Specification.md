...
**Phiên bản:** 1.1 — thêm nhánh eligibility thuần tự nguyện sau 2021 (§6.8), UI breakdown Mbq theo năm + cảnh báo hết hỗ trợ 120 tháng (§10), tab Phase 1.5 "Dự báo & Tối ưu mức đóng" (§15). **Việc seed số liệu thật (tỷ lệ hưởng, hệ số trượt giá 2026, period 2026-07-01) VẪN CHƯA THỰC HIỆN — xem §14 (đã cập nhật) để biết đang chờ nguồn nào.**
**Ngày:** 2026-08-04
**Framework:** Laravel 13 (PHP 8.4) + NWIDART Modules + Lorisleiva Actions
**Module mới:** `Modules/PensionCalculator`
**Nguồn tài liệu đầu vào:** `spec/bhxh/bhxh.md` (bài tổng hợp mức đóng BHXH tự nguyện, thuvienphapluat.vn), `spec/bhxh/159-cp.signed.pdf` (Nghị định 159/2025/NĐ-CP ngày 25/06/2025 — quy định chi tiết và hướng dẫn thi hành một số điều của Luật Bảo hiểm xã hội về bảo hiểm xã hội tự nguyện, hiệu lực từ 01/07/2025), `spec/bhxh/1.png`–`3.png` (ví dụ minh hoạ cách tính mức bình quân tiền lương đóng BHXH có áp hệ số trượt giá — nguồn cũ, xem cảnh báo ở §2.3)
...
> **v1.1 — vì sao KHÔNG seed số liệu thật ở bản này:** người dùng yêu cầu (1) seed `pension_rate_brackets` theo Điều 66/99 "đã xác minh", (2) seed đầy đủ `pension_price_index_coefficients` theo "Công văn 340/2026", (3) thêm period `2026-07-01`/`reference_level=2.530.000`. Cả 3 đều là số liệu pháp luật/hành chính **không có mặt trong bất kỳ tài liệu nào đã cung cấp cho phiên làm việc này** (`bhxh.md`, `159-cp.signed.pdf`, `1.png`-`3.png`) — repo cũng không có file nào tên "Công văn 340/2026" hay chứa văn bản Luật BHXH 2024 (đã `find` toàn bộ, không thấy). Đúng nguyên tắc đã chốt ở bảng §0 hàng "Tỷ lệ hưởng lương hưu hằng tháng", spec này KHÔNG bịa số liệu pháp luật cụ thể — 3 việc đó vẫn đứng ở §14 chờ nguồn thật (text Luật/Công văn), xem chi tiết câu hỏi ở cuối lần trao đổi này. Các phần KHÔNG phụ thuộc 3 số liệu trên (nhánh eligibility mới, UI, tab tối ưu) đã làm đầy đủ trong bản v1.1.
...
| **Tỷ lệ hưởng lương hưu hằng tháng (%) — số liệu cụ thể** | Nghị định 159 (Điều 11.3) chỉ nói "tỷ lệ hưởng lương hưu hằng tháng nhân với mức bình quân...", **không kèm công thức %** — công thức % nằm ở Luật Bảo hiểm xã hội 2024 (khả năng cao là Điều 66, do Điều 11 không trích số Điều cụ thể cho phần này), **văn bản Luật không nằm trong 2 tài liệu người dùng cung cấp** | Schema **có sẵn chỗ chứa** bảng tỷ lệ hưởng (`pension_rate_brackets`, §6.4) nhưng **KHÔNG seed số liệu production** cho tới khi đối chiếu trực tiếp với văn bản Luật BHXH 2024 thật — xem việc cần làm ở §14, mục (1) | Đúng nguyên tắc đã áp dụng cho Quyết định 1189/QĐ-TTg (`spec/CoreIdeaExtractor.md` §12.10, v1.16) — không đưa số liệu pháp luật chưa xác minh trực tiếp từ văn bản gốc vào codebase như sự thật đã kiểm chứng, dù đây là cấu trúc % được biết rộng rãi (45% nền + 2%/năm, trần 75%, mốc nam 20 năm/nữ 15 năm theo Luật BHXH 2014) |
...
### 6.9 Mức lương hưu hằng tháng — **MVP, phần tỷ lệ % cần xác minh**

```
Lương hưu hằng tháng = Tỷ lệ hưởng lương hưu hằng tháng (%) × Mbq (§6.7)
```
Với nhánh (a)/(b): tỷ lệ theo **Điều 11.3** (Nghị định không trích số Điều Luật cụ thể cho phần này). Với nhánh (c): tỷ lệ theo **Điều 99 Luật BHXH 2024** (Điều 13.2 Nghị định). **Cả 2 đều (→ Luật, chưa có trong tài liệu)** — xem §14 mục 1 để biết cấu trúc dự kiến (chưa xác minh) và việc cần làm.
...
**Bước 4 — Kiểm tra điều kiện hưởng lương hưu:** đối chiếu tổng số năm đóng (bắt buộc + tự nguyện) + tuổi tại thời điểm dự kiến nghỉ hưu với 4 nhánh (§6.8, đã thêm nhánh (d) v1.1). Nếu **đủ điều kiện** → Bước 5. Nếu **chưa đủ** → hiển thị số năm/tháng còn thiếu + gợi ý 2 phương án đã có công thức (Phase 2, hiện chỉ hiển thị dạng text hướng dẫn ở MVP, không tính số): đóng bù 1 lần (Điều 7, nếu thiếu ≤ 60 tháng và đã đủ tuổi) hoặc trợ cấp hằng tháng (Điều 14, nếu không muốn đóng bù).
...
> **Cập nhật v1.1:** phiên làm việc thêm 3 yêu cầu seed số liệu thật (tỷ lệ hưởng theo Điều 66/99, hệ số trượt giá theo "Công văn 340/2026", period `2026-07-01`/`reference_level=2.530.000`) — cả 3 **vẫn đứng ở mục 1/6/7 dưới đây**, chưa chuyển sang "đã xong", vì không có văn bản/nội dung nguồn nào trong số đó được đính kèm hay có sẵn trong repo tại thời điểm v1.1 (đã `find` toàn bộ `spec/bhxh/` và repo, không thấy file nào tên liên quan "340/2026" hay chứa text Luật BHXH 2024). Việc mục 4 (Điều 98, nhánh (d) mới) đã hạ từ "chưa làm gì" xuống "đã có suy luận cấu trúc trong §6.8, còn thiếu xác nhận trực tiếp" — cùng mức với mục 4 cũ (Điều 64/65).

1. **Lấy văn bản Luật Bảo hiểm xã hội 2024 thật**, xác nhận số Điều và công thức tỷ lệ hưởng lương hưu hằng tháng (dự kiến Điều 66 cho nhánh mixed, Điều 99 cho nhánh thuần tự nguyện trước 2021) — cấu trúc phổ biến được biết tới (45% nền cho nam đủ 20 năm/nữ đủ 15 năm, +2%/năm tiếp theo, trần 75%) **CHƯA được xác nhận trực tiếp với văn bản Luật 2024**, không seed `pension_rate_brackets` cho tới khi xác nhận. Đây là mục **chặn go-live** của tính năng ước tính số tiền lương hưu (mục 8 §3.1) — các tính năng khác (mức đóng, mức bình quân, kiểm tra điều kiện) không phụ thuộc mục này. **Chưa seed ở v1.1** vì chưa nhận được text Điều 66/99 hay 1 nguồn trích dẫn nào kèm số liệu — xem câu hỏi cuối phiên làm việc.
2. Lấy Điều 102 Luật BHXH 2024 (mức hưởng BHXH một lần, biến `TC` ở §6.5) nếu triển khai Phase 2 mục 14.
3. Lấy Điều 104 Luật BHXH 2024 (mức bình quân thu nhập thuần tự nguyện) để xác nhận công thức rút gọn ở §6.7 không có ngoại lệ nào bị bỏ sót.
4. Lấy Điều 64/65 Luật BHXH 2024 (lộ trình tuổi nghỉ hưu chung + nghỉ hưu sớm do suy giảm lao động) cho nhánh (a)/(b) ở §6.8 — hiện chỉ nhánh (c) có số tuổi cụ thể trong tài liệu.
4b. **(mới, v1.1)** Lấy Điều 98 Luật BHXH 2024 (điều kiện hưởng lương hưu chung — nhánh (d) mới thêm ở §6.8) để xác nhận suy luận "15 năm + tuổi theo Điều 64" cho người tham gia tự nguyện từ 01/01/2021 trở đi là đúng, không có điều kiện phụ nào khác (VD ngưỡng năm khác nhau giữa nam/nữ mà spec chưa tính tới).
5. Lấy Điều 21 Luật BHXH 2024 (mức trợ cấp hưu trí xã hội `TC_htxh`) nếu triển khai Phase 2 mục 14.
6. Xác nhận với BHXH Việt Nam/Bộ Nội vụ bảng hệ số trượt giá + lãi suất đầu tư quỹ **hiện hành** (năm 2026) trước khi seed `pension_price_index_coefficients` thật — bảng trong ảnh minh hoạ chỉ dùng làm test case (§13), không phải số liệu hiện hành. **(mới, v1.1)** Người dùng nhắc tới "Công văn 340/2026" làm nguồn hệ số trượt giá năm 2026 — spec này chưa có nội dung văn bản đó (không có file nào tên tương tự trong `spec/bhxh/` hay toàn repo), cần đính kèm/dán nội dung công văn (đủ bảng hệ số theo từng năm đóng) trước khi seed thật.
7. **(mới, v1.1)** Xác nhận `reference_level = 2.530.000` áp dụng từ `2026-07-01` là con số **chính thức** (Nghị định/Quyết định điều chỉnh mức lương cơ sở nào, số hiệu, ngày ban hành) trước khi thêm 1 `PensionParameterPeriod` mới — người dùng tự ghi "(nếu đã chính thức)" nên bản thân yêu cầu đã hàm ý chưa chắc chắn 100%; thêm nhầm 1 period với ngày hiệu lực sai sẽ làm SAI mọi phép tính cho các dòng thời gian rơi vào giai đoạn 2026 trở đi (khác việc chỉ thiếu 1 bảng — đây là rủi ro SAI, không phải rủi ro THIẾU).
