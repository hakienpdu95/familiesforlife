...
<section class="bg-neutral text-neutral-content pt-12 pb-10">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid lg:grid-cols-[5fr_7fr] gap-6 items-stretch">
            <a href="{{ route('post.public.article', ['slug' => $lead->slug]) }}" class="group flex flex-col h-full">
            ...
            <div class="flex flex-col h-full">
                <ul class="flex flex-col gap-1 flex-1 justify-between">
                    @foreach($rest as $t)
                    <li>
                        <a href="{{ route('post.public.article', ['slug' => $t->slug]) }}" class="group flex bg-base-100 text-base-content">
                            <span class="flex-none w-1.5 bg-primary"></span>
                            <div class="px-4 py-3">
