...
<div class="flex flex-col gap-4">
    <div class="form-control">
        ...
        <input type="text" name="name" value="{{ old('name', $category->name ?? '') }}"
               placeholder="VD: Đồ dùng sơ sinh" class="input input-bordered input-sm" required>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="form-control">
            ...
            <input type="text" name="icon" value="{{ old('icon', $category->icon ?? '') }}"
                   placeholder="ti-folder" class="input input-bordered input-sm font-mono">
        </div>
        <div class="form-control">
...
<div class="flex justify-end gap-2 mt-6">
    <a href="{{ route('backend.products.categories.index') }}" class="btn btn-ghost btn-sm">Hủy</a>
