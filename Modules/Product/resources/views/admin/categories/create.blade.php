...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Thêm danh mục sản phẩm</h1>
        <p class="text-sm text-base-content/50 mt-0.5">Danh mục dùng để phân loại catalog sản phẩm/dịch vụ</p>
    </div>
...
<form method="POST" action="{{ route('backend.products.categories.store') }}" novalidate data-category-form>
    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   ...
                                   placeholder="VD: Đồ dùng sơ sinh" maxlength="150" autofocus>
