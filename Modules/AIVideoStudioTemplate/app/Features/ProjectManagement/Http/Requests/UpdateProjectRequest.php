...
/**
 * spec/AIVideoStudioTemplate_Technical_Specification.md §7 — `status` chỉ đổi được qua form edit
 * (§2.1 — draft|active|archived), create luôn khởi tạo 'draft' theo default của Model.
 * Tập giá trị lấy từ hằng số Model (§4.1, v1.7) — tránh lệch giữa form và validate.
 */
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'video_formula' => ['nullable', 'string', Rule::in(array_keys(AiVideoStudioProject::VIDEO_FORMULAS))],
            ...
            'status' => ['nullable', Rule::in(array_keys(AiVideoStudioProject::STATUSES))],
        ];
    }
    ...
    public function toData(): array
    {
        return [
            ...
            'videoFormula' => $this->input('video_formula') ?: null,
