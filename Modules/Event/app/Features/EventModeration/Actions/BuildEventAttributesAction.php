...
class BuildEventAttributesAction
{
    ...
    public function handle(EventData $data): array
    {
        ...
        return [
            ...
            // spec/Heritage_Technical_Specification.md §8.1 — tuỳ chọn ở cả 2 loại location_type
            // (1 sự kiện trực tuyến vẫn có thể "diễn ra tại" 1 di tích về mặt tổ chức/chủ đề).
