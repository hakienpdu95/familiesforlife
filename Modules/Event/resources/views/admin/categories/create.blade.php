...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Thêm danh mục sự kiện</h1>
        <p class="text-sm text-base-content/50 mt-0.5">Danh mục dùng để phân loại và lọc sự kiện</p>
    </div>
    <a href="{{ route('backend.event.categories.index') }}" class="btn btn-ghost btn-sm gap-1.5">
...
<form method="POST" action="{{ route('backend.event.categories.store') }}" novalidate data-event-category-form>
    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   ...
                                   placeholder="VD: Hoạt Động Ngoài Trời" maxlength="100" autofocus>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <input type="color" name="color_hex" value="{{ old('color_hex', '#94a3b8') }}"
                                       class="input input-bordered input-sm w-full h-9 p-1 @error('color_hex') input-error @enderror">
            ...
            <div class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body p-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('backend.event.categories.index') }}" class="btn btn-ghost btn-sm flex-1">Hủy</a>
