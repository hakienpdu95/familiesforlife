...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-base-content/50 mt-0.5">{{ $tag->name }}</p>
    </div>
...
<form method="POST" action="{{ route('backend.post.tags.update', $tag) }}" novalidate>
    @csrf
    @method('PUT')
        ...
        <div class="card-body">
            ...
            <div class="form-control">
                ...
                <p class="text-xs text-base-content/40 mt-1">
                    Đường dẫn (slug) giữ nguyên <code>{{ $tag->slug }}</code> khi đổi tên.
                </p>
            </div>
