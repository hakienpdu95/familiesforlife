    ...
    public static function groups(): array
    {
        return [
            'Cấu trúc & câu trả lời' => [
                ...
                [
                    'label' => 'Mỗi câu ngắn gọn (không quá khoảng 20 từ) và không dùng thuật ngữ/cụm từ chung chung thiếu ngữ cảnh cụ thể',
                    'hint' => 'VD "giải pháp hiệu quả"/"chiến lược phù hợp" không nói rõ áp dụng cho ai/trường hợp nào — vừa khó để AI trích, vừa ít giá trị thật với người đọc. Câu dài nhiều mệnh đề nên tách thành 2 câu ngắn hơn.',
                ],
                [
                ...
                [
                    'label' => 'Trình bày so sánh/các bước thực hiện bằng khối "Bảng so sánh"/"Hướng dẫn từng bước" có sẵn, không viết văn xuôi dài dòng',
                    'hint' => 'Dùng đúng khối content-block (Comparison/Howto) thay vì bảng HTML tự chèn trong đoạn văn bản — vừa dễ đọc hơn, vừa render nhất quán trên mọi bài viết.',
                ],
                [
            ...
            'Uy tín & bằng chứng' => [
                ...
                [
                    'label' => 'Nếu có lời chứng thực/trải nghiệm thật của người dùng, dùng khối "Lời chứng thực khách hàng" có sẵn — nêu rõ tên người thật, không tự bịa',
                    'hint' => 'Khối content-block riêng (khác Trích dẫn có nguồn — đó là số liệu/nghiên cứu bên thứ 3) hiển thị đúng tên/ảnh/kết quả đạt được, tăng độ tin cậy cho cả người đọc lẫn AI.',
                ],
                [
