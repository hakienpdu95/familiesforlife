 ...
 * style_sample, family_values_focus, created_by/updated_by) thay vì chạy lại chuỗi migration cũ —
 * dữ liệu giai đoạn dev, chưa có bản ghi thật cần giữ (xem chú thích tương tự ở migration cũ
 * 2026_07_28_000001_make_cie_category_foundations_shared_across_categories.php bên
 * CoreIdeaExtractor).
 */
