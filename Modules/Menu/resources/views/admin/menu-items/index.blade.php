...
@section('content')
<div x-data="menuItemListPage({{ Js::from([
    'apiUrl'     => route('backend.api.menu.items'),
    'reorderUrl' => route('backend.menu.items.reorder'),
]) }})">
        ...
        <div class="card-body py-3 px-4">
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    ...
                    <div class="input input-sm input-bordered flex items-center gap-2 bg-base-100">
                        ...
                        <input type="text" x-model="filters.search" @input.debounce.350ms="onFilterChange()"
                               placeholder="Nhập nhãn menu..." class="grow bg-transparent outline-none text-sm">
                ...
                <div class="form-control w-56">
                    ...
                    <select x-model="filters.location" @change="onFilterChange()" class="select select-sm select-bordered w-full">
...
<dialog id="menuItemDeleteModal" class="modal">
    <div class="modal-box max-w-sm">
        <h3 class="font-bold text-lg text-error">Xác nhận xoá</h3>
        <p class="py-3 text-sm text-base-content/70">
            Bạn có chắc muốn xoá mục menu
            <strong id="menuItemDeleteItemLabel" class="text-base-content"></strong>?
        </p>
        <div class="modal-action mt-4">
            <button id="menuItemConfirmDeleteBtn" class="btn btn-error btn-sm">Xoá</button>
            <button class="btn btn-ghost btn-sm" onclick="menuItemDeleteModal.close()">Hủy</button>
        </div>
    </div>
