...
/**
 * Menu chính (location=header) cho cổng thông tin công khai — cấu trúc theo spec/header.html
 * (mega-menu 2 cấp: vài mục nhóm nhiều danh mục con qua dropdown, vài mục link thẳng 1
 * danh mục, kết ở 1 nhóm "Sự kiện gia đình"), nội dung dùng đúng category/thương hiệu của
 * familiesforlife (KHÔNG copy nhãn/link của site tham khảo — xem
 * Modules\Post\Database\Seeders\PostDemoSeeder / Modules\Event\Database\Seeders\EventDemoSeeder
 * cho danh sách category thật đã seed).
 *
