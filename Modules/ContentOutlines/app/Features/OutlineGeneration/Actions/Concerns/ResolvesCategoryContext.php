...
namespace Modules\ContentOutlines\Features\OutlineGeneration\Actions\Concerns;
...
/**
 * Dùng chung bởi CreateContentOutlineAction/RegenerateContentOutlinePromptAction — tra ngữ cảnh
 * chuyên mục NGAY TRƯỚC khi gọi BuildContentOutlinePromptAction (Action đó không tự query, xem
 * docblock §3.1 spec). Đổi tên từ ResolvesCategoryFoundation (v1.2) — thêm
 * resolveExistingArticleTitles() cho gợi ý internal link THẬT (§4.6, tham khảo
 * piperocket.digital/checklists/content-marketing-checklist — "build an internal-linking plan").
 */
trait ResolvesCategoryContext
{
     ...
     * prompt do BuildContentOutlinePromptAction tự cắt theo outline_depth, ở đây trả NGUYÊN
     * danh sách đã cắt sẵn bởi Action đó (tối đa `content_foundation.existing_articles.max_titles`).
     */
