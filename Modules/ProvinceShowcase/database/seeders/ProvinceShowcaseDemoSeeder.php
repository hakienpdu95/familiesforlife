 ...
 * Di sản + 6 bài Ẩm thực + 10 sản phẩm OCOP + 4 sự kiện + 2 banner province_top. Chạy Action
 * THẬT (create → submit/approve → publish) cùng nguyên tắc PostDemoSeeder/EventDemoSeeder — nên
 * seeder này chạy SAU ApprovalDatabaseSeeder + ProvinceShowcaseCategorySeeder + OcopDatabaseSeeder.
 *
...
class ProvinceShowcaseDemoSeeder extends Seeder
{
    ...
    private const ARTICLES = [
        ...
        [
            ...
            'slug'     => 'demo-province-hue-dai-noi-hue',
        ...
        [
            ...
            'slug'     => 'demo-province-hue-chua-thien-mu',
        ...
        [
            ...
            'slug'     => 'demo-province-hue-lang-tu-duc',
        ...
        [
            ...
            'slug'     => 'demo-province-hue-bun-bo-hue',
        ...
        [
            ...
            'slug'     => 'demo-province-hue-com-hen-vy-da',
        ...
        [
            ...
            'slug'     => 'demo-province-hue-banh-khoai',
        ...
        [
            ...
            'slug'     => 'demo-province-ca-mau-mui-ca-mau',
        ...
        [
            ...
            'slug'     => 'demo-province-ca-mau-vuon-quoc-gia',
        ...
        [
            ...
            'slug'     => 'demo-province-ca-mau-ramsar',
        ...
        [
            ...
            'slug'     => 'demo-province-ca-mau-lau-mam',
        ...
        [
            ...
            'slug'     => 'demo-province-ca-mau-ba-khia-rach-goc',
        ...
        [
            ...
            'slug'     => 'demo-province-ca-mau-ca-loc-nuong-trui',
    ...
    private const EVENTS = [
        [
            'province' => 'hue', 'title' => 'Festival Huế 2026', 'slug' => 'demo-province-festival-hue-2026',
        ...
        [
            'province' => 'hue', 'title' => 'Lễ hội Áo dài Huế', 'slug' => 'demo-province-le-hoi-ao-dai-hue',
        ...
        [
            'province' => 'ca-mau', 'title' => 'Lễ hội Nghinh Ông Sông Đốc', 'slug' => 'demo-province-le-hoi-nghinh-ong-song-doc',
        ...
        [
            'province' => 'ca-mau', 'title' => 'Ngày hội Cua Cà Mau', 'slug' => 'demo-province-ngay-hoi-cua-ca-mau',
    ...
    public function run(): void
    {
        ...
        $bannerCount  = $this->seedBanners($creator);

        $previousUser ? Auth::login($previousUser) : Auth::logout();

        $this->command->info("  ✓ Province Showcase demo data seeded ({$articleCount} bài viết, {$ocopCount} sản phẩm OCOP, {$eventCount} sự kiện, {$bannerCount} banner).");
    }
    ...
    private function seedEvents(User $creator, User $editor, User $head): int
    {
        ...
        foreach (self::EVENTS as $i => $def) {
            ...
            $event = app(CreateEventAction::class)->handle(EventData::from([
                ...
                'price_type'     => 'free',
                'poster_path'    => 'events/posters/' . $def['slug'] . '.jpg',
    ...
    // ──────────────────────────────────────────────────────────────
    // BANNERS (placement=province_top, target_type=province)
    // ──────────────────────────────────────────────────────────────

    private function seedBanners(User $creator): int
    {
        $banners = [
            ['province' => 'hue', 'title' => 'Banner chuyên đề Huế (Demo)'],
            ['province' => 'ca-mau', 'title' => 'Banner chuyên đề Cà Mau (Demo)'],
        ];

        $created = 0;
        foreach ($banners as $def) {
            $provinceCode = $this->provinceCode($def['province']);

            if (Banner::where('placement', 'province_top')->where('target_value', $provinceCode)->exists()) {
                continue;
            }

            Banner::create([
                'placement'        => 'province_top',
                'target_type'      => BannerTargetType::Province,
                'target_value'     => $provinceCode,
                'title'            => $def['title'],
                'image_path'       => 'banners/demo-province-' . $def['province'] . '.jpg',
                'image_width'      => 1200,
                'image_height'     => 150,
                'image_size_bytes' => 80000,
                'alt_text'         => $def['title'],
                'is_active'        => true,
