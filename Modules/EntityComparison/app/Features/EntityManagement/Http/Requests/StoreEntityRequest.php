...
/**
 * spec/Entity_Comparison_Module_Technical_Spec.md §9 — lớp 1/2 của defense-in-depth cho rule
 * "EntityType đã xóa mềm thì không tạo Entity mới" (lớp 2 nằm ở CreateEntityAction). Authorization
 * thật nằm ở EntityAdminController::authorizeResource() (constructor).
 */
class StoreEntityRequest extends FormRequest
{
    ...
    /**
     * Rule động theo Criteria đã gán cho entity_type_id gửi lên — không thể khai tĩnh ở đây vì
     * phụ thuộc dữ liệu request (§7.1 mục 4: form chỉ hiện tiêu chí đã gán cho type đó).
     *
